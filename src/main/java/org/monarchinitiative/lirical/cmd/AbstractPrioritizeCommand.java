...
public abstract class AbstractPrioritizeCommand {
    ...
    @CommandLine.Option(names={"-g","--global"}, description = "global analysis")
    ...
    @CommandLine.Option(names={"-o","--output-directory"}, description = "directory into which to write output file(s).")
     ...
     * be {@code sample1.tsv}. */
    @CommandLine.Option(names={"-x", "--prefix"},description = "prefix of outfile")
    protected String outfilePrefix="lirical";
    @CommandLine.Option(names={"--orpha"},description = "use Orphanet annotation data")
