...
public class SimulatePhenopacketWithVcfCommand extends AbstractBenchmarkCommand {
//    private static final Logger LOGGER = LoggerFactory.getLogger(SimulatePhenopacketWithVcfCommand.class);
//
//    @CommandLine.Option(names = {"-v", "--template-vcf"},
//            required = true,
//            description = "path to template VCF file")
//    private Path templateVcfPath;
//    @CommandLine.Option(names = {"--phenopacket-dir"},
//            description = "path to directory with multiple phenopackets")
//    private Path phenopacketDir;
//    @CommandLine.Option(names = {"-outputfile"},
//            description = "name of the output file with simulation results")
//    private Path simulationOutFile = null;
...
//    @CommandLine.Option(names={"--output-vcf"},
//            description = "output a VCF file or files with results of the simulation")
//    private boolean outputVCF = false;
//    /** If true, the program will output an HTML file.*/
//    @CommandLine.Option(names="--output-html",
//            description = "Provide HTML output (default: ${DEFAULT-VALUE})")
//    protected boolean outputHTML=true;
//    /** If true, the program will output a Tab Separated Values file.*/
//    @CommandLine.Option(names="--output-tsv",
//            description = "output a TSV file or files with results of the simulation (default: ${DEFAULT-VALUE})")
//    protected boolean outputTSV=false;
//    @CommandLine.Option(names={"--random"},
//            description = "randomize the HPO terms from the phenopacket")
...
//
//
//    private void runOnePhenotypeOnlyAnalysis(Lirical lirical, Path phenopacketPath) {
//        PhenoOnlyCaseSimulator simulator = new PhenoOnlyCaseSimulator(lirical);
//        simulator.run();
