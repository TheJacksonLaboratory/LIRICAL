...
public enum FrequencySource {
    ...
    public static final Set<FrequencySource> ALL_EXAC_SOURCES = EnumSet.range(EXAC_AFRICAN_INC_AFRICAN_AMERICAN, EXAC_SOUTH_ASIAN);

    public static final Set<FrequencySource> ALL_EXTERNAL_FREQ_SOURCES = EnumSet.range(THOUSAND_GENOMES, GNOMAD_G_SAS);
