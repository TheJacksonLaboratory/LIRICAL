...
import static org.monarchinitiative.lirical.exomiser_db_adapter.model.pathogenicity.PathogenicitySource.DBVAR;
...
public class AlleleProtoAdaptor {
    ...
    private static final Map<String, PathogenicitySource> PATHOGENICITY_SOURCE_MAP = Map.of(
            "POLYPHEN", POLYPHEN,
            "MUT_TASTER", MUTATION_TASTER,
            "SIFT", SIFT,
            "CADD", CADD,
            "REMM", REMM,
            "REVEL", REVEL,
    ...
    private static Map<String, FrequencySource> prepareFrequencySources() {
        ...
        builder.put("ESP_AA", ESP_AA);
        builder.put("ESP_EA", ESP_EA);
        ...
        builder.put("GNOMAD_G_AMI", GNOMAD_G_AMI);
        ...
        builder.put("GNOMAD_G_MID", GNOMAD_G_MID);
