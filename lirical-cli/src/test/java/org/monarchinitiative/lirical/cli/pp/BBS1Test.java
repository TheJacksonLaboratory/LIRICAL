...
import org.monarchinitiative.lirical.cli.yaml.YamlConfig;
...
public class BBS1Test {
    ...
    private static final Path TEST_PHENOPACKET_DIR = TestResources.LIRICAL_TEST_BASE.resolve("pp");
    ...
    public void testGetVcfYaml() {
        String vcfOpt = yamlConfig.vcf();
        assertThat(vcfOpt, is(notNullValue()));
        assertThat(vcfOpt, equalTo("/path/to/examples/BBS1.vcf"));
    }
