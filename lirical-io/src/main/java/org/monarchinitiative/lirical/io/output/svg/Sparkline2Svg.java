...
public class Sparkline2Svg extends Lirical2Svg {
    ...
    public Sparkline2Svg(TestResult result, boolean useGenotype, MinimalOntology ontology) {
        ...
        indicesObserved = new ArrayList<>(observedIndexList.size());
        for (Value2Index value2Index : observedIndexList) {
            indicesObserved.add(value2Index.getOriginalIndex());
        }
        ...
        indicesExcluded = new ArrayList<>(excludedIndexList.size());
        for (Value2Index value2Index : excludedIndexList) {
            indicesExcluded.add(value2Index.getOriginalIndex());
        }
